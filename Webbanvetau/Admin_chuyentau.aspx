...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
  ...
  <%--                      <asp:CompareValidator ID="cvSSngay" Display="Dynamic" EnableViewState="true"  ControlToValidate="txtNgaydi" Type="Date" Operator="GreaterThanEqual" runat="server" ErrorMessage="Ngày đi phải lớn hơn hoặc bằng ngày hiện tại."></asp:CompareValidator>--%>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtGiaTien" runat="server" type="number" placeholder="Nhập giá tiền"></asp:TextBox>&nbsp;&nbsp;
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic"  runat="server" ErrorMessage="Không được để trống." ControlToValidate="txtGioden"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>     
                            ...
                            <asp:TemplateField HeaderText="Xử lý">
                                <ItemTemplate>
                                    ...
                                    <asp:ImageButton ID="IBT_xoa" runat="server" CommandName="xoa"  CommandArgument='<%# Eval("malichtrinh") %>'
                                            ImageUrl="~/Anh/xoa.png" CssClass="anhxuly" OnClientClick="return confirm('Bạn có chắc muốn xóa lịch trình này không');" />                            
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
